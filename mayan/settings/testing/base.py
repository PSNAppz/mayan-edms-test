...
setting_namespace.get_setting(name="MEDIA_ROOT").set_value(value=MEDIA_ROOT_TEMPORARY)
setting_namespace.update_globals(global_symbol_table=globals())
...
INSTALLED_APPS = [
    cls
    for cls in INSTALLED_APPS
    if cls != "whitenoise.runserver_nostatic"  # NOQA: F405
]
